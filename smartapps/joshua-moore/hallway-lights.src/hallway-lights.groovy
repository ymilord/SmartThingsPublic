...
preferences {
	section("Using this ...") {
    	input "master", "capability.colorTemperature", multiple: false, required: true, title: "Master device"
	}
    section("Control these ...") {
    	input "slaves", "capability.colorTemperature", multiple: true, required: true, title: "Slave devices"
    }
}
