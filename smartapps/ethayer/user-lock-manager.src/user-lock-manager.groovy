...
definition(
    ...
    iconUrl: "http://ecx.images-amazon.com/images/I/41Cf9oNLHTL._SY300_.jpg",
    iconX2Url: "http://cdn1.thegadgetflow.com/wp-content/uploads/2015/02/Wink-Schlage-Connect-Camelot-Touchscreen-Deadbolt-02.jpg",
    iconX3Url: "http://cdn1.thegadgetflow.com/wp-content/uploads/2015/02/Wink-Schlage-Connect-Camelot-Touchscreen-Deadbolt-02.jpg")
...
def isManualUnlock(codeData) {
  ...
  if (manualUnlock) {
    if ((codeData.usedCode == "") || (codeData.usedCode == manually)) {
